                            ...
                            <table align="center" bgcolor="#efedf0" border="0" cellpadding="0" cellspacing="0" style="" width="100%">
                                <tr>
                                    <td align="center" class="tbl_main" style="vertical-align:top;min-width:700px;width:700px;" valign="top">
                                        <table width="700" border="0" cellspacing="0" cellpadding="0" style="min-width:700px;width:700px;" class="tbl_main" align="center">
                                            <tr>
                                                <td align="center" valign="top" bgcolor="#ffffff" style="background-color: #ffffff;border-radius:3px;-webkit-border-radius:3px; -moz-border-radius:3px;">
                                                    <img class="logo-img" alt="Logo.png" src="<?php echo base_url() ?>assets/images/logo.png" style="width:50%; padding-top: 40px;" />
                                                    <table width="640" border="0" cellspacing="0" cellpadding="0" style="min-width:640px;width:640px;" class="tbl_main">
                                                        <tr>
                                                            <td align="left" class="Pad_LR10" style="font-family: 'Muli', Arial, Helvetica, sans-serif;font-size:16px;line-height:20px;letter-spacing:.01em;mso-line-height-rule:exactly;font-weight:normal;padding:15px 30px 30px 30px;" valign="top"><?php echo $body; ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
