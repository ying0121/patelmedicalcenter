                                    ...
                                    <div class="container">
                                        <div id="demo">
                                            <div class="container my-5">
                                                <h1 class="title-heading title-post-heading mb-5"><?php echo $component_text["menu_asthma"] ?></h1>
                                                <div class="row mb-5">
                                                    <div class="span12 main-gallery w-100">
                                                ...
                                                <h1 class="fs-5 mb-3"><?php echo $component_text["v_document"] ?></h1>
                                                <?php if (count($docs) == 0): ?>
