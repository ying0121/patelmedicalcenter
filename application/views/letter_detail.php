...
<body>
    ...
    <main>
        ...
        <div class="container my-5">
            <p class="h1"><?php echo $letter['title']; ?></p>
        </div>
        <div class="container mb-5">
            <div class="row">
                <div class="col-md-4">
                    <div class="d-flex justify-content-center justify-content-md-end my-md-3 mb-4 mb-md-0">
                        <i class="fa fa-<?php echo $letter['icon']; ?>" style="font-size: 240px;"></i>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="w-100 d-flex justify-content-center justify-content-md-start align-items-center flex-wrap gap-4 mb-3">
                        ...
                        <button id="request_letter" type="button" class="btn btn-lg btn-danger" data-mdb-ripple-init data-title="<?php echo $letter['title']; ?>"><?php echo $component_text['t_request']; ?></button>
                    </div>
        ...
        <!-- Letter Details -->
        <div class="container mb-5">
            <div class="mb-3 service-desc text-black"><?php echo $letter['short_desc'] ?></div>
            <div class="mb-3 service-desc text-black"><?php echo $letter['long_desc'] ?></div>
        </div>
    </main>
